...
import csv
import sys
sys.path.append('/content/drive/MyDrive/Project1/JointIDSF')
...
def predict(pred_config):
    ...
    with open(pred_config.output_file, mode='w', newline='', encoding='utf-8') as f:
    writer = csv.writer(f)
    for words, slot_preds, intent_pred in zip(lines, slot_preds_list, intent_preds):
        ...
        writer.writerow([intent_label_lst[intent_pred], line.strip()])
